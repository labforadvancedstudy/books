...
다양한 것들은 대략적인 레벨로 표현할 수 있습니다. 수학에서는 정확히 표현할 수 있습니다.

L9: x^9 + 1 = 0
L8: 9x^8 = 0
...

일론 머스크와 그 회사의 레벨을 살펴볼까요?

일론 머스크 제국 (개념적 구조)

L8: 일론 머스크 (최고 의사결정자)
L7: (일론 머스크 제국 모회사) 수석 비서실 & 개인 참모진
L6: 전략/재무/법무 고문단
L5: 각 회사 CEO
    - Tesla CEO (본인)
    - SpaceX CEO (본인)  
...
주커버그는 좀더 물리적으로 Meta가 있어서 표현하기 쉽군요.
...
재미있는 차이점은 일론 머스크는 이 회사들의 모회사를 논리적으로만 있고 (해당 논리적인 회사의 사장이 있고 비서와 참모가 실제로 있음.) 주커버그는 메타라는 물리적인 회사가 있다는 차이점이 있네요.

이를 추상화해서 일반적인 회사를 다음과 같이 레벨로 표현할 수 있겠군요.

(#대충 레벨 표현)

같은 방법으로 중세시대 신성 로마제국과 교황청의 추상화 레벨 표를 만들어 봅시다.

(#대충 레벨 표현)

레벨로 표현하니 게임같고 재밌죠? 저는 여기서 일반 패턴화 능력의 추상 레벨로 각 개인의 레벨을 표현해보기로 했습니다.

대충 이러한 레벨은 회사의 추상화 레벨과 비슷합니다. 레벨5인 사람은 CEO를 할수 있지만 레벨 7정도인 일론 머스크의 직책은 수행할 수 없습니다. 실제로 회사 운영은 대표의 권한보다 훨씬 더 넓습니다. 그러한 여러 회사를 운영하려면 훨씬 광범위합니다. 주커버그와 달리 일론 머스크의 경우 소프트웨어 회사만 있는게 아니죠. 그래서 메타 회장의 필요 추상화 능력을 7이라고 한다면 일론 머스크가 필요한 능력은 7.5에서 8사이가 될것 같네요.
...
(물론 우주가 정말로 "못 참았다"는 건 아닙니다. 그냥 자연법칙이죠. 하지만 이렇게 생각하면 재밌잖아요?)
...
(기질 독립성에 대해 더 알고 싶으면 공각기동대를 보세요. 마인크래프트 CPU로 AI 돌리는 이야기는... 너무 길어서 패스!)
