...
## L7: 3차원 언어의 가능성 — [Speculative]

인간 언어는 시간축에서 작동한다. 단어가 순서대로 나온다.

**[Correction 2026-04 — Speculative framing flagged]** 아래의 "3차원 문법" 가설은 **어떤 동료심사 논문에도 존재하지 않는다**. 동료심사된 결과는 다음 수준에 머물러 있다:

- Payne & McVay 1971 (*Science* 173:585): 혹등고래의 노래 구조 최초 기술.
- Whitehead 2003 (*Sperm Whales: Social Evolution in the Ocean*): 코다(coda)가 vocal clan 경계를 표식한다.
- Andreas et al. 2024 (*Nature Communications* 15:3617, [DOI:10.1038/s41467-024-47221-8](https://doi.org/10.1038/s41467-024-47221-8)): CETI 프로젝트가 sperm whale coda에 "phonetic alphabet"에 해당하는 **rubato·ornamentation** 변조가 있음을 보고. **공간 문법은 보고되지 않음**.

즉, 아래의 "X축=좌우, Y축=깊이, Z축=거리 + 시간축" 스킴은 저자의 **사변적 가설**이며, 현 시점 증거와 호환되지 않는다(향유고래는 초당 여러 클릭을 균일한 각도 내에서 발산하며, 깊이-과거/표면-현재 같은 의미 매핑을 지지하는 관측은 없다). Evidence Tier: [Speculative].
...
이런 공간적 문법으로 복잡한 역사적 서사를 인코딩할 수 있다 **[추측]**. 현실적으로는 coda의 **시간적 rhythm pattern + clan dialect**가 확인된 축이며, 공간축은 아직 가설이다.
